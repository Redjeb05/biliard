...
namespace biliard.Controllers
{
    ...
    public class TablesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TableId,AvailablePlaces,Smoker")] Table table)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TableId,AvailablePlaces,Smoker")] Table table)
        {
            if (id != table.TableId)
            {
                return NotFound();
